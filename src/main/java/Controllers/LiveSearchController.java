...
public class LiveSearchController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        for (Product product : list) {
            ...
            String category_id = product.getPro_category();
            
            out.println("<a href=\"/ProductController/" + category_id + "/" + product.getPro_id() + "\" class='text-decoration-none text-dark'>\n"
                    + "                                                        <div class=\"row\" style=\"width: 100%; height: auto; font-size: 14px\">\n"
                    + "                                                            <div class='col-md-3 '>\n"
                    + "                                                                <img style=\"width: 100%\" src=\"../../Root/Images/Product/" + imgStrings[0] + "\" alt=\"alt\"/>\n"
                    + "                                                            </div>\n"
                    + "                                                            <div class='col-md-7'>\n"
