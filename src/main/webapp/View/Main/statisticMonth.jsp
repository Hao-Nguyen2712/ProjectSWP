<%-- 
    Document   : statisticDay
    Created on : Feb 27, 2024, 7:55:43 PM
    Author     : joonn
--%>
                    ...
                    <div class="container-fluid bg-light" style="border-radius: 10px">
                        <div class="mb-3" style="padding-top: 25px; text-align: center">
                            ...
                            <form method="post" action="AdminController"  color: white">
                                ...
                                <input type="submit" name="btnSubmitForMonth" value="Report">
                                <a href="/AdminController/Export" class="btn btn-primary">Export</a>
                        ...
                        <table id="example" style="margin-top: 30px; ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="color: black"><%= rs.getInt("user_id")%></td>
                                    <td style="color: black"><%= rs.getString("user_fullname")%></td>
                                    <td style="color: black"><%= rs.getString("pro_name")%></td>                           
                                    <td style="color: black"><%= rs.getInt("od_quantity")%></td>
                                    <td style="color: black"><%= kdao.converterNumber(rs.getInt("order_totalMoney"))%></td>
