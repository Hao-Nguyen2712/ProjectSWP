...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../Root/Css/stylePayment.css">
        <link rel="stylesheet" href="../../Root/Css/css/notificationCss.css">
        <style>
            .buttonPayment {
                width: 100%;
                height: 40px;
                            ...
                            <div class="container paySlide">
                                ...
                                <table class="table totalTable">
                                    ...
                                    <tbody class="productShow">
                                        ...
                                        String[] imgaeList = pro.getPro_image().split("&");
                                                                                cart= new Cart(rs.getInt("cart_id"),rs.getInt("user_id"),rs.getInt("cart_quantity"),rs.getInt("pro_id"));

                                        %>

                                        <tr class="productShow-Items">
                                            <td class="productShow-Items-Names"><%= pro.getPro_name()%><strong> x <%= cart.getCart_quantity()%></strong></td>
                                            <td class="productShow-Items-Price">₫ <%= keyDAO.converterNumber(Integer.parseInt(pro.getPro_price())* cart.getCart_quantity())%></td>
                                        </tr>
                                    </tbody>
                                    <%
                                            totalMoney += Integer.parseInt(pro.getPro_price())* cart.getCart_quantity();
                                        }%>
                                    <tfoot>
                                        <tr class="amoutTable">
                                            <td>
                                            ...
                                            <td class="totalBefore">
                                                ₫<%= keyDAO.converterNumber(totalMoney)%>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="amoutTable">
                                            ...
                                            <td class="totalAfter">
                                                ₫<%= keyDAO.converterNumber(totalMoney + 20000)%>
                                            </td>
                                        </tr>
                                    </tfoot>
