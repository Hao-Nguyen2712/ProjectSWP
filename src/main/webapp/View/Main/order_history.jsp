...
<html>
    ...
    <body>
        ...
        <%           
            ...
            ResultSet rs_id = orderDAO.getAllOrderWithUserID(user_id);
            while (rs_id.next()) {
                if (!arr.contains(rs_id.getInt("order_id"))) {
                    arr.add(rs_id.getInt("order_id"));
                }
            }
                            ...
                            <tbody class="productShow">
                                <%                                            KeyboardDAO keyDAO = new KeyboardDAO();
                                    ...
                                    while (rs_infoProduct.next()) {
                                        ...
                                        Product product= proDAO.getProductByID(pro_id);
                                        status = rs_infoProduct.getString("order_status");
                                %>

                                <tr class="productShow-Items">
                                    <td class="productShow-Items-Names"><%= product.getPro_name() %><strong> x <%= quantity%></strong></td>
