...
<html>
    <head>
        ...
        <style>
            <%@include file="../../Root/Css/adminCss.css" %>
            <%@include file="../../Root/Css/stylePayment.css" %>
            <%@include file="../../Root/Css/notificationCss.css" %>
            .buttonPayment {
                width: 100%;
                height: 40px;
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                                <li class="sidebar-item">
                                    <a href="/AdminController/Confirm-Order" class="sidebar-link">Duyệt Đơn Hàng</a>
                                </li>
                                <li class="sidebar-item">
                    ...
                    <div class="container-fluid bg-light" style="border-radius: 10px">
                        <div class="main" style=" width: 100%; height: auto; padding-bottom: 50px; border-radius: 10px">
                            ...
                            <%
                                ...
                                int order_id = 0;
                                while (rs_id.next()) {
                                order_id = rs_id.getInt("order_id");
                                if (!arr.contains(order_id)) {
                                        arr.add(order_id);
                                    }
                                }
                                if (!arr.isEmpty()) {
                                    ...
                                    for (int i = 0; i < arr.size(); i++) {
                                        ...
                                        while (rs_info.next()) {
                                            ...
                                            sdt = rs_info.getString("order_phoneNumber");
                                        ...
                                        <div class="col-md-5 right">
                                            <div class="container paySlide">
                                                    ...
                                                    <tbody class="productShow">
                                                        <%                                            KeyboardDAO keyDAO = new KeyboardDAO();
                                                            ...
                                                            while (rs_infoProduct.next()) {
                                                                price = Integer.parseInt(rs_infoProduct.getString("od_price"));
                                                                quantity = rs_infoProduct.getInt("od_quantity");
                                                                pro_id = rs_infoProduct.getInt("pro_id");
                                                                Product pro = proDAO.getProductByID(pro_id);

                                                        %>

                                                        <tr class="productShow-Items">
                                                            <td class="productShow-Items-Names"><%= pro.getPro_name()%><strong> x <%= quantity%></strong></td>
                                                ...
                                                <div class="buttonPayment">
                                                    <a href="/AdminController/Accept-Order/<%=arr.get(i)%>">
                                                        Xác Nhận Đơn Hàng
                                                    </a>
                                                </div>
                                                </br>
                                                <div class="buttonPayment">
                                                    <a  href="/AdminController/Reject-Order/<%=arr.get(i)%>">
                                                        Từ Chối Đơn Hàng
                                                    </a>
                                                </div>
