...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../Root/Css/productCss.css"/>
    </head>
                    ...
                    <div class="new-product">
                        ...
                        <div>
                            ...
                            <ul class="product_list_widget">
                                <%
                                    while (rs_new.next()) {
                                        if (rs_new.getString("pro_category").equals("Keyboard")) {
                                            name = "Keyboard";
                                        } else if (rs_new.getString("pro_category").equals("Kit")) {
                                            name = "Kit-ban-phim";
                                        } else if (rs_new.getString("pro_category").equals("Keycap")) {
                                            name = "Key-cap";
                                        } else if (rs_new.getString("pro_category").equals("Switch")) {
                                            name = "Switch";
                                        } else if (rs_new.getString("pro_category").equals("Mouse")) {
                                            name = "Mouse";
                                        } else if (rs_new.getString("pro_category").equals("Earphone")) {
                                            name = "Earphone";
                                        }
