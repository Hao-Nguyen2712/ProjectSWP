                ...
                <div class="container-xxl">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="navbar-brand" href="/"><img style="width: 100px;"
                                                              src="../../Root/Images/Logo/z4705695345706_20ca59964f9ad379fcebb44ceaad6cd4-removebg-preview.png"
                                                              alt=""></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="navbar-collapse-box d-flex align-items-center">
                                    ...
                                    <ul class="navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/ProductController/Mouse"">MOUSE</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/ProductController/Earphone"">EARPHONE</a>
                                        </li>
                                        ...
                                        %>
                                        <li class="nav-item support">
                                            <a class="nav-link" href="/LoginController/login">ĐĂNG NHẬP</a>
                                        </li> 
                                        <%   
                                        }
                                        %>
